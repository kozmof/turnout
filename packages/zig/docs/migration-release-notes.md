...
The packaged WASM path is `turnout-runtime/zig-runtime/turnout-runtime.wasm`. `turnout-scene-runner` consumes the client and default instance exported by `turnout-runtime/zig-runtime`.
