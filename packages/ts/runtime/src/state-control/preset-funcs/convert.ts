...
export type ArrayToArray = (
  a: AnyArrayValue<readonly TagSymbol[]>,
  b: AnyArrayValue<readonly TagSymbol[]>,
) => AnyArrayValue<readonly TagSymbol[]>;

export type ToBooleanProcess<T extends AnyValue, U extends AnyValue> = (
  a: T,
  b: U,
) => BooleanValue<readonly TagSymbol[]>;
export type ToItemtProcess<
  T extends AnyArrayValue<readonly TagSymbol[]>,
  U extends NonArrayValue,
  Idx extends NumberValue<readonly TagSymbol[]>,
> = (a: T, idx: Idx) => U;
