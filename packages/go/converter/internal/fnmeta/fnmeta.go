...
var builtinFnTable = map[string]FnSpec{
	...
	"arr_get_number":       {Kind: FnKindArrGet, ReturnType: ast.FieldTypeNumber},
	"arr_get_str":          {Kind: FnKindArrGet, ReturnType: ast.FieldTypeStr},
	"arr_get_bool":         {Kind: FnKindArrGet, ReturnType: ast.FieldTypeBool},
	"arr_get_array":        {Kind: FnKindArrGet},
	"arr_get_record":       {Kind: FnKindArrGet},
