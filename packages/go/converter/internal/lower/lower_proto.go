...
func lowerArgWithTypes(arg ast.SyntaxArg, bindingTypes map[string]ast.FieldType, ds *diag.DiagSink) *turnoutpb.ArgModel {
	switch a := arg.(type) {
	case *ast.RefArg:
...
func lowerArgsWithTypes(args []ast.SyntaxArg, bindingTypes map[string]ast.FieldType, ds *diag.DiagSink) []*turnoutpb.ArgModel {
