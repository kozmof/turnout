# Turnout Literal Types and Pattern Matching Specification
...
* typed construction of template values
...
The initial implementation should prioritize statically decidable matching and avoid general-purpose regular expressions.
